...
func (_c *UserCreate) AddProviderIDs(ids ...int) *UserCreate {
...
func (_c *UserCreate) AddKitIDs(ids ...int) *UserCreate {
	_c.mutation.AddKitIDs(ids...)
	return _c
}

// AddKits adds the "kits" edges to the BrandKit entity.
func (_c *UserCreate) AddKits(v ...*BrandKit) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddKitIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.KitsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
